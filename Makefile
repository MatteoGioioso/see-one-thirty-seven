...
down:
	NAME_1=etcd-1 NAME_2=etcd-2 NAME_3=etcd-3 HOST_1=etcd1 HOST_2=etcd2 HOST_3=etcd3 docker-compose down --remove-orphans
...
start.node1: build
	NAME_1=etcd-1 NAME_2=etcd-2 NAME_3=etcd-3 HOST_1=etcd1 HOST_2=etcd2 HOST_3=etcd3 docker-compose up --build --remove-orphans postgresql -d
